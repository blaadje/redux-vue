    ...
    return (0, _vue.defineComponent)({
      ...
      setup: function setup(_, _ref) {
        ...
        var handleStoreUpdate = function handleStoreUpdate() {
          ...
          currentStateValue = Object.entries(initState( // not sure about that
          state, attrs) || {}).reduce(function (acc, _ref2) {
        ...
        return function () {
          handleStoreUpdate();
          return (0, _vue.h)(children, _objectSpread(_objectSpread({}, props.value), attrs));
        };
      }
    });
  };
